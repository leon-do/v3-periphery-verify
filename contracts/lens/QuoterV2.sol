...
contract QuoterV2 is IQuoterV2, IETCswapV3SwapCallback, PeripheryImmutableState {
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) private view returns (IETCswapV3Pool) {
        return IETCswapV3Pool(PoolAddress.computeAddress(factory, PoolAddress.getPoolKey(tokenA, tokenB, fee)));
    }

    /// @inheritdoc IETCswapV3SwapCallback
    function etcswapV3SwapCallback(
        ...
        IETCswapV3Pool pool = getPool(tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        IETCswapV3Pool pool = getPool(params.tokenIn, params.tokenOut, params.fee);
