...
import { abi as PAIR_V2_ABI } from '@etcswap/v2-core/build/ETCswapV2Pair.json'
...
describe('V3Migrator', () => {
  ...
  let factoryV3: IETCswapV3Factory
  let token: TestERC20
  let weth9: IWETH9
  let nft: MockTimeNonfungiblePositionManager
  let migrator: V3Migrator
  let pair: IETCswapV2Pair
  ...
  beforeEach('add V2 liquidity', async () => {
    ...
    pair = new ethers.Contract(pairAddress, PAIR_V2_ABI, wallet) as IETCswapV2Pair
