import { abi as IETCswapV3PoolABI } from '@etcswap/v3-core/artifacts/contracts/interfaces/IETCswapV3Pool.sol/IETCswapV3Pool.json'
import { Fixture } from 'ethereum-waffle'
import { BigNumber, constants, ContractTransaction, Wallet } from 'ethers'
import { ethers, waffle } from 'hardhat'
import { IETCswapV3Pool, IWETH9, MockTimeSwapRouter, TestERC20 } from '../typechain'
...
describe('SwapRouter gas tests', function () {
  ...
  const swapRouterFixture: Fixture<{
    ...
    pools: [IETCswapV3Pool, IETCswapV3Pool, IETCswapV3Pool]
    ...
    const pools = poolAddresses.map((poolAddress) => new ethers.Contract(poolAddress, IETCswapV3PoolABI, wallet)) as [
      IETCswapV3Pool,
      IETCswapV3Pool,
      IETCswapV3Pool
    ]
  ...
  let pools: [IETCswapV3Pool, IETCswapV3Pool, IETCswapV3Pool]
  ...
  describe('#exactInput', () => {
    ...
    it('0 -> 1 minimal', async () => {
      const calleeFactory = await ethers.getContractFactory('TestETCswapV3Callee')
